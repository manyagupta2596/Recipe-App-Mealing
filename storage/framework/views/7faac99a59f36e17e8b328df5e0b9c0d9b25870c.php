            ...
            <div class="space-y-4">
                <div class="items-start md:grid md:grid-cols-9 md:space-x-6">
                    ...
                    <div class="w-full md:col-span-4">
                        <input type="text" name="name" id="name" value="<?php echo e(Request::old('name')); ?>" class="border-1 border-gray-100 shadow bg-opacity-20 rounded-lg placeholder-gray-500 w-full lg:w-60 focus:outline-none focus:ring-1 focus:border-green-500 focus:ring-green-500 dark:bg-gray-900 dark:border-transparent dark:text-gray-200">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="items-start md:grid md:grid-cols-9 md:space-x-6">
                    ...
                    <div class="w-full md:col-span-4">
                        <input type="text" name="servings" id="servings" value="<?php echo e(Request::old('servings')); ?>" class="border-1 border-gray-100 shadow bg-opacity-20 rounded-lg placeholder-gray-500 w-full lg:w-60 focus:outline-none focus:ring-1 focus:border-green-500 focus:ring-green-500 dark:bg-gray-900 dark:border-transparent dark:text-gray-200">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="items-start md:grid md:grid-cols-9 md:space-x-6">
                    ...
                    <div class="w-full md:col-span-4">
                        <input type="text" name="timing" id="timing" value="<?php echo e(Request::old('timing')); ?>" class="border-1 border-gray-100 shadow bg-opacity-20 rounded-lg placeholder-gray-500 w-full lg:w-60 focus:outline-none focus:ring-1 focus:border-green-500 focus:ring-green-500 dark:bg-gray-900 dark:border-transparent dark:text-gray-200">
...
unset($__errorArgs, $__bag); ?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('recipes.create')->html();
} elseif ($_instance->childHasBeenRendered('2YqmSJx')) {
    $componentId = $_instance->getRenderedChildComponentId('2YqmSJx');
    $componentTag = $_instance->getRenderedChildComponentTagName('2YqmSJx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2YqmSJx');
} else {
    $response = \Livewire\Livewire::mount('recipes.create');
    $html = $response->html();
    $_instance->logRenderedChild('2YqmSJx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
                <div class="md:space-y-2">
                    ...
                    <div>
                        <textarea name="instruction" id="instruction" class="border-1 border-gray-100 shadow bg-opacity-20 rounded-lg placeholder-gray-500 w-full h-64 focus:outline-none focus:ring-1 focus:border-green-500 focus:ring-green-500 dark:bg-gray-900 dark:border-transparent dark:text-gray-200"><?php echo old('instruction'); ?></textarea>
                    </div>
                </div>
                <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP\Mealing\resources\views/recipes/create.blade.php ENDPATH**/ ?>