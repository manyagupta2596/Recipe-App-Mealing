        ...
        <?php $__currentLoopData = $recipe->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex flex-row bg-gray-50 dark:bg-gray-600 shadow rounded p-4 mb-4">
                <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl">
                    <img class="rounded-full w-10 h-10" src="https://www.gravatar.com/avatar/<?php echo e(md5($comment->user->email)); ?>?s=40" alt="<?php echo e($comment->user->name); ?>">
                </div>
                <div class="flex flex-col flex-grow ml-4">
                    <div class="text-xs font-light text-gray-500 dark:text-gray-300 pb-1">
                        <?php echo e($comment->user->name); ?> - <span class="italic"><?php echo $comment->created_at; ?></span>
                        <?php if($comment->user->id == Auth::id()): ?>
                            - <span class="italic cursor-pointer" wire:click="deleteComment(<?php echo e($comment->id); ?>)">Delete</span>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\PHP\Mealing\resources\views/livewire/comments.blade.php ENDPATH**/ ?>